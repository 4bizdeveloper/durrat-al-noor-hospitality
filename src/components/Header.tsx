...
const Logo=({mobile=false}:{mobile?:boolean})=><Image src="/logo.png" alt="Durrat Al Noor Hospitality Logo" width={mobile?150:170} height={mobile?46:52} priority={!mobile} className={mobile?"h-8 w-auto object-contain":"h-8 w-auto object-contain sm:h-9 lg:h-10"} sizes={mobile?"150px":"(max-width:640px) 140px, 170px"}/>;
