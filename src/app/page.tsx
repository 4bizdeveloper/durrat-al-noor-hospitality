...
export const metadata: Metadata = {
  title: "Hospitality Staffing & Cleaning Dubai | Durrat Al Noor",
  description:
    "Explore hospitality staffing, housekeeping and deep cleaning services in Dubai and across the UAE. Discuss your requirements with Durrat Al Noor Hospitality.",
};
...
export default function Home() {
  return (
    <div className="w-full overflow-x-hidden antialiased bg-white text-slate-900 selection:bg-[#DAB672] selection:text-slate-950">
      ...
      >
        ...
        <div className="container relative z-20 mx-auto px-4 sm:px-6 lg:px-8 flex w-full flex-col justify-center">
          <header className="max-w-4xl">
            ...
            <h1 className="mt-6 hero-title text-3xl font-black tracking-tight sm:text-5xl md:text-6xl text-white leading-[1.15] drop-shadow-md">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
            <article className="lg:col-span-7 flex flex-col justify-center">
              ...
              <p className="copy mt-6 text-lg sm:text-xl font-bold text-slate-950 leading-snug">
                Thoughtful service starts with the right people.
              </p>

              <p className="copy mt-4 text-sm sm:text-base leading-relaxed text-slate-700 font-medium">
              ...
              <p className="copy mt-4 text-sm sm:text-base leading-relaxed text-slate-700 font-medium flex items-center gap-2">
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <p className="eyebrow text-xs uppercase tracking-widest text-[#8C5E00] font-black">
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid gap-8 lg:grid-cols-2">
          <div className="rounded-3xl border border-slate-200/80 bg-white p-8 sm:p-12 shadow-sm flex flex-col justify-center">
            <p className="eyebrow flex items-center gap-2 text-xs uppercase tracking-widest text-[#8C5E00] font-black">
          ...
          <div className="rounded-3xl bg-[#0B192C] p-8 sm:p-12 text-white shadow-xl flex flex-col justify-center ring-1 ring-white/10">
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-between gap-8 md:flex-row md:items-center">
          ...
          <div className="flex flex-row flex-wrap items-center gap-3 sm:gap-4 shrink-0">
            <Link
              href="/contact-us/"
