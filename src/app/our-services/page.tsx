    ...
    <div>
      <section className="relative overflow-hidden bg-[#0B192C] py-16 md:py-24 text-white"><div className="absolute inset-0 bg-[url(https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?auto=format&fit=crop&w=2000&q=85)] bg-cover bg-center"/><div className="absolute inset-0 bg-[#0B192C]/70"/>
        <div className="container relative">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-white/75">
            ...
            people, properties and daily operations.
          </p>
          <div className="mt-8 flex flex-wrap gap-2">
            {data.map((service, i) => (
              ...
              >
                {service.title.replace(" Services", "").replace(" Staffing", "")}
              </a>
            ))}
          </div>
        </div>
        ...
        <div className="container">
          {data.map((service, i) => (
            <article
              id={`service-${i + 1}`}
              key={service.title}
              className="scroll-mt-24 grid gap-10 border-b border-[#ded7ca] py-16 lg:grid-cols-2 lg:items-center"
            >
              <div>
              ...
              <div className="rounded-[28px] bg-[#F2EEE5] p-10">
                <p className="text-7xl font-black text-[#C5A059]/30">0{i + 1}</p>
                <p className="mt-5 text-xl font-semibold text-[#0B192C]">
                  {service.title}
                </p>
                <p className="copy mt-3">
                  Professional support arranged around your property's
                  operational needs.
                </p>
              </div>
            </article>
      ...
      <section className="section">
        <div className="container max-w-4xl">
          ...
          <h2 className="heading mt-3">Common questions about our services.</h2>
      ...
      <section className="section bg-[#0B192C] text-white">
